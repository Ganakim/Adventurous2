...
Combat = class Combat{
  ...
  setupPhase(){
    ...
    //button on characters' portraits
  }

  click_selectCharacter(character){
    this.characterSelected = character
  }

  click_selectAction(action){
    this.characterSelected.savedAction.action = ((targets) => action(Targets))
  }

  click_selectTargets(target){
    if (this.characterSelected.savedAction.targets < this.characterSelected.savedAction.nbTargets){
      this.characterSelected.savedAction.targets.push(target)
    }
    if (this.characterSelected.savedAction.targets == this.characterSelected.savedAction.nbTargets){
